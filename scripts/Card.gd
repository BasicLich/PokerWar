...
func move_card(dest, rotate = null, _scale = null):
		...
		if _scale != null:
			$Tween.interpolate_property(self, "scale", scale, _scale, 0.3, Tween.TRANS_LINEAR, Tween.EASE_IN)
		$Tween.start()
...
#
#
#onready var card : Resource
#var card_name : String
#var cost : int
#var type : String
#var power : int
#
# #modified on creation to store default location on Table node
#var hand_location
#var hand_rotation
#var base_z
#var focus_area
...
#
##Used to tween card from it's position to a destination.
